...
<div class="container"">
  <div class="row">
    ...
    <div class="col" style="  
         	...
         	<form  action="cliente_guardar.jsp" method="GET" style="
			  padding-left:  25px;
			  padding-bottom:  25px;
			  padding-right: 50px;
			  margin-left:   0px;
    		...
    		<a class="btn btn-primary" style="background-color: #E26C6C; border: 0px;" onclick="ir('cliente.jsp');">Cancelar</a>
    		<a class="btn btn-primary" style="background-color: #E26C6C; border: 0px;" onclick="ir('index.jsp');">Salir</a>
    			<%
    		try{
    		String msm = request.getParameter("msm"); 
