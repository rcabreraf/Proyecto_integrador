  ...
  <div class="row">
    ...
    <div class="col" style="  
    		...
    		<br>
    			...
    			<%=adm.getRegistroClientes()%>
    		
    		<br>
    		
    		<br><br>
    		<button style="background-color: #E26C6C; border: 0px;" onclick="ir('Administrador.jsp?msm=Datos Actualizados al Dia');">Actualizar datos</button>
...
function print(x){
	...
	var z = document.getElementById(""+x+"2").value;
	location.href="Administrador_cambio.jsp?dato1="+y+"&dato2="+z+"";
}
function ir(path){
	location.href=path;
}
